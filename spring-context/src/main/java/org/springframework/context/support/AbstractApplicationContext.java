...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public AbstractApplicationContext() {
		mylog.debug("父类初始化资源解析器，实例化PathMatchingResourcePatternResolver");
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			mylog.debug("===========解析BeanDefinition完成，并添加到registry实现类中===========");
	...
	protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		mylog.debug("添加ResourceEditorRegistrar注册默认的bean转换器");
		...
		mylog.debug("添加容器映射ApplicationContext");
		beanFactory.registerResolvableDependency(ApplicationContext.class, this);

		mylog.debug("添加ApplicationListenerDetector，属于BeanPostProcessor，初始化完成后，执行after方法，注册监听器");
