...
public class DispatcherServlet extends FrameworkServlet {
	public static final Logger mylog = Logger.getLogger(DispatcherServlet.class);
	...
	static {
		...
		try {
			mylog.debug("加载mvc默认strategies配置DispatcherServlet.properties");
	...
	private void initHandlerAdapters(ApplicationContext context) {
		...
		if (this.detectAllHandlerAdapters) {
			//初始化请求、返回处理适配器RequestMappingHandlerAdapter
			// Find all HandlerAdapters in the ApplicationContext, including ancestor contexts.
			mylog.debug("初始化请求、返回处理适配器RequestMappingHandlerAdapter");
